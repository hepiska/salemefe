...
const CmsListItem = ({ image, title, price, desc, onEdit, onDelete, category, id }) => (
  <Wrapper width='100%' padding='16px 16px' align='flex-start' direction='row' shadow='0 1px 4px 0 rgba(0, 0, 0, 0.16)'>
    ...
    <Wrapper flex='4' align='flex-start' padding='8px'>
      ...
      <Wrapper justify='center' height='100%' direction='row' align='center'>
        <Button color='yellow' onClick={onEdit} id={id} icon="pencil alternate" labelPosition='left' content="Edit" style={{ marginRight: "24px" }} />
        <Button color='red' onClick={onDelete} id={id} icon='trash' labelPosition='left' content="Delete" />
      </Wrapper>
    </Wrapper>
  </Wrapper>
)
